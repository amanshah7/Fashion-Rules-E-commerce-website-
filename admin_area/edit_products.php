    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            name ="product_desc" class="form-control"
             required="required" placeholder="Enter product description"/>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="text" id ="product_keywords" value="<?php echo $product_keywords ?>" 
             name ="product_keywords" class="form-control"
             required="required" placeholder="Enter product keywords"/>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
...
while($row_brands_all = mysqli_fetch_assoc($result_brands_all)){
    ...
    ?>
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            class="form-control"
             required="required" placeholder="Enter product price"/>
        </div>
        <div class="text-center">
            <input type="submit" name="edit_product"
             class="btn btn-primary px-3 mb-3" value="Update product">
        </div>

    </form>
</div>

<!---editing product form ends here-->
<?php
...
date=NOW() where product_id='$edit'";
